...
class Game7_Win1 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game7_win1)
        ...
        player_button.setOnClickListener {
            ...
            Utilities.playSound(this,R.raw.game7_win1){
        ...
        findViewById<Button>(R.id.next_game).setOnClickListener {
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    ...
                    if (next_game != null)
                        Utilities.startActivity(this@Game7_Win1, next_game)
                    else
                        Utilities.startActivity(this@Game7_Win1, LandingActivity::class.java)
