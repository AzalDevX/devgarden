...
class Game4_Win1 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game4_win1)
        ...
        player_button.setOnClickListener {
            ...
            Utilities.playSound(this,R.raw.game4_win1){
        ...
        findViewById<Button>(R.id.next_game).setOnClickListener {
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    Log.i("devl|game41", "Moving to the next game")

                    if (next_game != null)
                        Utilities.startActivity(this@Game4_Win1, next_game)
                    else
                        Utilities.startActivity(this@Game4_Win1, LandingActivity::class.java)
