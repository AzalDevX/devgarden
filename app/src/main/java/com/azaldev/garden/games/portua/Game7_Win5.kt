...
class Game7_Win5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game7_win5)
        ...
        findViewById<Button>(R.id.next_game).setOnClickListener {
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    ...
                    if (next_game != null)
                        Utilities.startActivity(this@Game7_Win5, next_game)
                    else
                        Utilities.startActivity(this@Game7_Win5, LandingActivity::class.java)
