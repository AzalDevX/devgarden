...
class Game1_Win2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game1_win2)
        ...
        player_button.setOnClickListener {
            ...
            Utilities.playSound(this,R.raw.game1_win2){
        ...
        findViewById<Button>(R.id.next_game).setOnClickListener {
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    ...
                    if (next_game != null)
                        Utilities.startActivity(this@Game1_Win2, next_game)
                    else
                        Utilities.startActivity(this@Game1_Win2, LandingActivity::class.java)
