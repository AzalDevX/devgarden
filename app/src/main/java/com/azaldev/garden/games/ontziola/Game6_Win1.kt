...
class Game6_Win1 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_game6_win1)
        ...
        next_game.setOnClickListener {
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    ...
                    if (next_game != null)
                        Utilities.startActivity(this@Game6_Win1, next_game)
                    else
                        Utilities.startActivity(this@Game6_Win1, LandingActivity::class.java)
